...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tell us about your project. Lumina partners with teams to design and deliver cloud-native solutions." },
          ...
          <div className="mt-10 space-y-5 text-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="mailto:hello@luminalabs.io" className="text-foreground hover:text-primary">
                  hello@luminalabs.io
                </a>
              </div>
            </div>
          ...
          >
            {sent ? (
              ...
              <div className="space-y-5">
                ...
                <button
                  type="submit"
                  className="group inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-5 py-3 text-sm font-medium text-primary-foreground transition-shadow hover:shadow-glow"
                >
                  Send message
